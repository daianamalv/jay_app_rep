...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { avatar_link: @tour.avatar_link, description: @tour.description, title: @tour.title } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { avatar_link: @tour.avatar_link, description: @tour.description, title: @tour.title } }
